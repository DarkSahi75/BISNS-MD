...
* 
* *GROUP FULL :- _Rs 3500_* 

> C̲H̲A̲N̲N̲E̲L̲ L̲I̲N̲K̲❗ :-
     ~https://whatsapp.com/channel/0029VazV7oYBVJl03iU3au1a~
> ~F͟O͟L͟L͟O͟W͟E͟R͟S͟ C͟O͟U͟N͟T͟ 17k+❗~
 
> *ප්‍රමෝශන් ඇඩ් එක්ක් දාගන්නවානම් පමණක් මෙතනින් එහා ඉදිරියට යන්න_☺️🪄*
 > *Proceed here only if you are placing a promotional ad_☺️🪄* ` `;
    ...
    await conn.sendMessage(from, {
      ...
      { buttonId: prefix + '2hour', buttonText: { displayText: '📁. Want 2h Pan' }, type: 1 },
