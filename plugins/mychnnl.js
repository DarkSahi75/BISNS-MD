...
//nst { fetchJson } = require("../lib/functions");
...
cmd(
  {
    pattern: "dinuvre",
    desc: "Send caption first and song after to JID",
    category: "download",
    react: "🎧",
    filename: __filename,
  },
...
ඔයාහේ ආසම පාටිම් ලස්සන හාර්ට් එකක් දාගෙන යමු ළමයෝ 🫠💗◦◦◦`;
      ...
      console.error(e);
      reply("*😓 උණුසුම් දෝෂයකි! පස්සේ උත්සහ කරන්න.*");
    }
  }
);
